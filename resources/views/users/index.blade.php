...
<div class="kt-subheader  kt-grid__item" id="kt_subheader">
    <div class="kt-container  kt-container--fluid ">
        <div class="kt-subheader__main">
            ...
            <h3 class="kt-subheader__title">用戶</h3>
            ...
            <div class="kt-subheader__breadcrumbs">
                ...
                <span class="kt-subheader__breadcrumbs-separator"></span>
                <a href="#" class="kt-subheader__breadcrumbs-link">用戶</a>
            </div>
        </div>

        <div class="kt-subheader__toolbar">
            <a href="{{route('users.create')}}" class="btn btn-label-brand btn-bold"><i
        ...
        <div class="kt-portlet__body">
            ...
            <div id="filter-div" class="row kt-margin-b-20 collapse">
                ...
                <div class="col-lg-3 kt-margin-b-10-tablet-and-mobile">
                    <label>帳號:</label>
                    <input type="text" class="form-control filter-input" name="email" placeholder="E-Mail"
                           aria-label="email">
                </div>
                <div class="col-lg-3 kt-margin-b-10-tablet-and-mobile">
                    <label>名稱:</label>
                    <input type="text" class="form-control filter-input" name="name" placeholder="Name"
                           aria-label="Name">
                </div>
                ...
                <tr>
                    <th data-priority="1">
                        <label class="kt-checkbox kt-checkbox--single kt-checkbox--solid" style="width: auto;">
                            <input type="checkbox" class="kt-group-checkable"><span></span> 帳號(名稱)
                        </label>
                    </th>
                    <th data-priority="3">
                        職務
